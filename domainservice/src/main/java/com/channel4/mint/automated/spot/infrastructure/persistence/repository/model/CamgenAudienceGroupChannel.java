...
/**
 * The persistent class for the CAMGEN_AUDIENCE_GROUP_CHANNEL database table.
 * 
 */
@Entity
@Table(name="CAMGEN_AUDIENCE_GROUP_CHANNEL")
@NamedQuery(name="CamgenAudienceGroupChannel.findAll", query="SELECT c FROM CamgenAudienceGroupChannel c")
public class CamgenAudienceGroupChannel implements Serializable {
	...
	/**
	 * Instantiates a new camgen audience group channel.
	 */
	public CamgenAudienceGroupChannel() {
	}
