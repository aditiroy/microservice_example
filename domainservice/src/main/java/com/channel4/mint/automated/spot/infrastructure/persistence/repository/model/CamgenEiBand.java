...
/**
 * The persistent class for the CAMGEN_EI_BAND database table.
 * 
 */
@Entity
@Table(name="CAMGEN_EI_BAND")
@NamedQuery(name="CamgenEiBand.findAll", query="SELECT c FROM CamgenEiBand c")
public class CamgenEiBand implements Serializable {
	...
	/**
	 * Instantiates a new camgen ei band.
	 */
	public CamgenEiBand() {
	}
