...
/**
 * The persistent class for the CAMGEN_EXTRACT_PARAMETER database table.
 * 
 */
@Entity
@Table(name="CAMGEN_EXTRACT_PARAMETER")
@NamedQuery(name="CamgenExtractParameter.findAll", query="SELECT c FROM CamgenExtractParameter c")
public class CamgenExtractParameter implements Serializable {
	...
	/**
	 * Instantiates a new camgen extract parameter.
	 */
	public CamgenExtractParameter() {
	}
