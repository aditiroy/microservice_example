...
/**
 * The persistent class for the RQST_DEMAND_SUPPLY_CRITERIA database table.
 * 
 */
@Entity
@Table(name = "RQST_DEMAND_SUPPLY_CRITERIA")
@NamedQuery(name = "RqstDemandSupplyCriteria.findAll", query = "SELECT r FROM RqstDemandSupplyCriteria r")
public class RqstDemandSupplyCriteria implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="RQST_DEMAND_SUPPLY_CRITERIA_ID")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private long rqstDemandSupplyCriteriaId;
	...
	private CamgenRqstDemandSupply camgenRqstDemandSupply;

	public RqstDemandSupplyCriteria() {
	}

	public long getRqstDemandSupplyCriteriaId() {
		return this.rqstDemandSupplyCriteriaId;
	}

	public void setRqstDemandSupplyCriteriaId(long rqstDemandSupplyCriteriaId) {
		this.rqstDemandSupplyCriteriaId = rqstDemandSupplyCriteriaId;
	}
	...
	public CamgenRqstDemandSupply getCamgenRqstDemandSupply() {
		return this.camgenRqstDemandSupply;
	}

	public void setCamgenRqstDemandSupply(CamgenRqstDemandSupply camgenRqstDemandSupply) {
		this.camgenRqstDemandSupply = camgenRqstDemandSupply;
	}
